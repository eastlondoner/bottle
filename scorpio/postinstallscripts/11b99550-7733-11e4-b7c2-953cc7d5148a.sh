#!/bin/shrack_region="LON"input_data_container="Container a"output_folder="results"status_file="COMPLETED"mr_options=""jar_container="z_DO_NOT_DELETE_scorpio_JARS"cluster_name="11b99550-7733-11e4-b7c2-953cc7d5148a"input_jar="JAR 1"input_file="input.txt"output_data_container="Container a-out"## Shebang line deliberately missing because this is a template
