#!/bin/shrack_region="LON"input_data_container="Container b"output_folder="results"status_file="COMPLETED"mr_options=""jar_container="z_DO_NOT_DELETE_scorpio_JARS"cluster_name="ab3302a0-7730-11e4-b4cb-15125cc9b1ea"input_jar="JAR 1"input_file="input.txt"output_data_container="Container b-out"## Shebang line deliberately missing because this is a template
