#!/bin/shrack_region="LON"input_data_container="Container c"output_folder="results"status_file="COMPLETED"mr_options=""jar_container="z_DO_NOT_DELETE_scorpio_JARS"cluster_name="7b853750-7729-11e4-8686-9d8a39718782"input_jar="JAR 1"input_file="input.txt"output_data_container="Container c-out"## Shebang line deliberately missing because this is a template
