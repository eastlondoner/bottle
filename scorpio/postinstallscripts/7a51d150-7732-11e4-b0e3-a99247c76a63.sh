#!/bin/shrack_region="LON"input_data_container="Container b"output_folder="results"status_file="COMPLETED"mr_options=""jar_container="z_DO_NOT_DELETE_scorpio_JARS"cluster_name="7a51d150-7732-11e4-b0e3-a99247c76a63"input_jar="JAR 1"input_file="input.txt"output_data_container="Container b-out"## Shebang line deliberately missing because this is a template
