#!/bin/shrack_region="LON"input_data_container="Container b"output_folder="results"status_file="COMPLETED"mr_options=""jar_container="z_DO_NOT_DELETE_scorpio_JARS"cluster_name="b256f5a0-772b-11e4-8d85-5d120537ca16"input_jar="JAR 1"input_file="input.txt"output_data_container="Container b-out"## Shebang line deliberately missing because this is a template
