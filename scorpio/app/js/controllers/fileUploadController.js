define(['angular', 'controllersModule'], function (angular, controllers) {
     ...
     */
    controllers.controller('FileUploadController', function ($scope, $state, container, $upload, iaModalSheet, containerService, iaLoadingSpinner) {
